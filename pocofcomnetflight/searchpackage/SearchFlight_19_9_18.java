...
public class SearchFlight_19_9_18 {
...
//		//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='nf-search-popup--children']//div[@class='nf-search-popup--ageinc']"))).click();
		...
		//no insurance
		//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"basket-control\"]/ul/li[6]/div/div[3]/div/div[1]/ul[2]/li[5]/p[2]/span"))).click();
