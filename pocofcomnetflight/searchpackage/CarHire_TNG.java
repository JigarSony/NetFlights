...
public class CarHire_TNG {
	...
	public void setup() {
		...
		//click on hotels
		driver.findElement(By.linkText("Car hire")).click();
	}

	@org.testng.annotations.Test
	public void Test() {
		String pickuplocation = "Dubai, United Arab Emirates, DXB";
		driver.findElement(By.id("mat-input-1")).sendKeys(pickuplocation);
		driver.findElement(By.xpath("//span[@class='mat-option-text']")).click();

		String driverage = "35";
		driver.findElement(By.id("mat-input-0")).sendKeys(driverage);

		driver.findElement(By.xpath("//button[@class='btn btn-primary btn-block']")).click();


		driver.findElement(By.xpath("//li[@class='car-option car-1']//a[@title='Select this car']")).click();

		driver.findElement(By.xpath("//a[@id='add-car-rental-to-basket']")).click();
	...
	public void tearDown() {
		...
		driver.close();
		System.out.println("e2e for CarHire  Pass Successfully");
	}
