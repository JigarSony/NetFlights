...
public class SearchFlight_25_9_19_TNG {
...
*/
		...
		WebElement Airlinebox = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='airline-select']")));
		...
		*/
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@id,'leadPassengerDetails_cbxConfirmBasket')]"))).click();
